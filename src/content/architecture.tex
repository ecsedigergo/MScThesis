...
Each cape have 8 general purpose expander slot, for which the pin layout is expressed in the following \ref{table:expander_pin_layout} table. \footnote{ }
...
\todo[inline]{some more info needed about physical elements. To which elements they are connected to, what is the responsibility for them}
