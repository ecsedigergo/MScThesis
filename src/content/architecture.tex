...
\begin{figure}[h]
	\centering
	\includegraphics[width=150mm, keepaspectratio]{figures/modes3/layoutBig1.png}
...
\todo[inline]{create More suitable figure here for BBB expendable interfaces. For example: \url{https://github.com/FTSRG/BME-MODES3/wiki/HW-BeagleBone-expander-assignments}}
...
\todo[inline]{Give proper details about G0-G15 pins, the table is not showing all of them like \url{https://github.com/FTSRG/BME-MODES3/wiki/HW-Expander-design}. The GPIO mapping for all pins is not really necessary here...}  
...
\todo[inline]{Should i reference anything regarding EMF?}
